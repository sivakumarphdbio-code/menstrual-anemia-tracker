...
with tab1:
    ...
    with col2:
        ...
        if calculate:
            score = 0
            if flow_days == "7 days or longer": score += 2
            if pad_frequency == "Every 1-2 hours": score += 4
            if clots == "Yes": score += 2
            if fatigue == "Severe exhaustion": score += 3
            if diet_habit == "Rarely": score += 2
